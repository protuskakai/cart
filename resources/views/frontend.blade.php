...
<body>
            ...
            <div class="container px-6 py-1 mx-auto">
                ...
                <nav  class="p-2 mt-4 text-white bg-green-400 sm:flex sm:justify-center sm:items-center">
                    <div class="flex flex-col sm:flex-row ">
						...
						<a class="mt-3 hover:underline sm:mx-3 sm:mt-0" href="{{ route('aboutus')}}">About us</a>
	...
	<div class="container px-6 py-3 mx-auto">
		<footer  class="p-2 mt-2 text-white bg-green-400 sm:flex sm:justify-center sm:items-center">
                <div class="flex flex-col sm:flex-row ">
                <a class="mt-3 hover:underline sm:mx-3 sm:mt-0" href="/">Copyright: North Rift Electronics 2022</a> 
        </footer>
	</div>
